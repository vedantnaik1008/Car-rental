...
// 		<div className='fixed bottom-0 z-30 flex gap-2 w-full hidden md:hidden'>
// 			{/* <a
...
// 				aria-label='Call to contact OwnWheelz.com'
// 				href={'tel:+91'}
// 				className='gap flex items-center justify-center rounded-xl border-4 border-gray-400 bg-white py-2 font-medium text-black transition-shadow duration-200 hover:bg-gray-100 hover:shadow-lg hover:shadow-sky-900/10 focus:outline-none focus-visible:ring focus-visible:ring-gray-400 max-md:w-1/2 md:rounded-md md:border-[2.5px] md:border-black/80 md:bg-opacity-0 md:px-4'>
// 				<IoMdCall color='' size='21px' />
// 				<span>Talk to Us</span>
// 			</a>
...
// 				className='flex items-center justify-center gap-2 rounded-xl border-4 border-emerald-900 bg-emerald-500 py-2 font-medium text-white transition-shadow duration-200 hover:bg-emerald-500/90 hover:shadow-lg hover:shadow-emerald-500/10 focus:outline-none focus-visible:ring focus-visible:ring-emerald-900 max-md:w-1/2 md:rounded-md md:border-none md:px-4'>
