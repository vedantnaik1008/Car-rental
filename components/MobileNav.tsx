		...
		<div id='navbar' className='w-full'>
			<div className={`w-full lg:hidden`}>
				<div className='flex items-center justify-between relative'>
					...
					<CallChats className='hidden md:flex md:items-center md:gap-4 md:absolute right-10 lg:hidden' />
					...
					<div
						className={
							open
								? 'absolute -right-10 -top-4 z-[50] h-screen w-[80%] translate-x-0 rounded-l-md bg-white px-5 py-10 shadow-2xl transition-all duration-300 ease-in-out sm:block lg:hidden'
								: 'absolute -right-10 -top-4 z-[50] h-screen w-[80%] translate-x-[200%] rounded-l-md bg-white px-5 py-10  shadow-2xl transition-all duration-300 ease-in-out sm:block lg:hidden'
						}>
